            ...
            <Container className='About FadeItems'>
                <Row>
                    <Col   className='aboutPicture'>
                        <img src={require("../aboutportrait2.png")} width='60%'  className='aboutPicture'  alt='family'/>
                    </Col>
                    <Col sm ='6' md='6' className='aboutHello'>
                        ...
                        <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                            <div>
                                <img src={require("../Lindsay Piethe Resume Website.png")} width='100%' className='resume' />
                            </div>
                        </Modal>
